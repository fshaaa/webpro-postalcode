import data from "./dataPostalCode.json" assert {type: "json"}
let data_postal = []
const data_prov = []

const provinsi = document.querySelector("#province")
const select = document.querySelector("#province")
const select_kab = document.querySelector("#city")
const kab = document.querySelector("#city")
